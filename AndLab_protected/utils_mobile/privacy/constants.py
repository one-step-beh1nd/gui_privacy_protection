...
# Fixed surface string for ablation mode (replacement_style="fixed_placeholder").
# Shown to the model and drawn on masked screenshots instead of TYPE#hash tokens.
